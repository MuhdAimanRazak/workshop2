...
/* =========================
   EDIT OWN PROFILE
========================= */
$staff_id = $current_user_id; // always edit logged-in user
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $conn->prepare(
        "UPDATE staff
         SET full_name=?, phone_no=?, email=?, address=?
         WHERE staff_id=?"
    );
    ...
    header("Location: ../dash/index.php"); // redirect to own details page
    exit;
}
?>
...
<div class="edit-row">
    ...
    <div class="form-group">
        ...
        <input type="text" name="staff_ic"
               value="<?= htmlspecialchars($staff['staff_ic']) ?>" required disabled>
    </div>
