...
<div class="add-student-white">
    ...
    <!-- BACK -->
    <a href="student.php" class="back-link" style="float:left;">← Back to Student Page</a>
    ...
    <!-- FORM -->
    <form class="csv-form"
          action="student_edit_template_process.php"
          method="post"
    ...
    <a href="student_edit_template.php" class="template-btn">
